    ...
    <div className="service-container min-w-full p-3 min-h-72 " id="services">
        ...
        <div className="container max-w-96 mx-auto px-5 flex flex-col gap-16 lg:max-w-3xl">
            ...
            <div className="service flex flex-row-reverse content-center ">
                ...
                <p className="text-left text-sm text-gray font-thin ">We provide budget-friendly app development services, delivering high-quality solutions customized to meet your specific requirements.</p>
            </div>
            <div className="service flex content-center justify-center gap-4">
                <div className="service-flex-container bg-dark-white text-center min-w-32 p-2 rounded-lg light-shadow lg:w-3/5 lg:h-48">
                    <div className="">
            ...
            <div className="service flex flex-row-reverse content-center ">
                ...
                <p className="text-left text-sm text-gray font-thin">Discover our budget-friendly AI and ML model development services, where we create high-quality and tailored solutions to meet your unique needs.</p>
            </div>
            <div className="service flex content-center justify-center gap-4 pb-12">
                ...
                <p className="text-left text-sm text-gray font-thin">Experience our budget-conscious video editing services, where we skillfully craft high-quality and personalized solutions to elevate your visual content.</p>
            </div>
        </div>
