...
const Footer = () => {
  ...
  return (
    ...
    <div className="container min-w-full bg-[#F3F8FF]">
      <div className="flex-container flex justify-around text-left pt-16 max-w-4xl mx-auto text-black">
      <div>
              <h1 className="font-normal text-base lg:text-xl lg:font-medium">About</h1>
              <p className="font-thin text-xs max-w-32 text-black lg:text-base lg:font-base lg:max-w-48">we are a cost-effective IT solutions service provider, dedicated to delivering professional websites and applications that empower businesses to thrive in the digital landscape.</p>
            </div>
            <div>
              <h1 className="font-normal text-base lg:text-xl lg:font-medium">Links</h1>
              <ul className="font-thin text-xs  lg:text-base lg:font-base">
                <li>
                  <a href="#">Twitter</a>
                </li>
                <li>
            ...
            <div>
              ...
              <p className="font-thin text-xs lg:text-base lg:font-base">We operate remotely</p>
            </div>
      </div>
            
           </div>
           <div className="about-section text-sm text-light-purple bg-[#F3F8FF] p-5 pb-16 pt-16">
